...
// import TwitterApi from "../../pages/Authentication/TwitterApi";
            ...
            <li>
              <Link to="/setting" className="">
                <FeatherIcon
                  icon="users"
                />
                <span>{props.t("CEX API Setting")}</span>
              </Link>
            </li>
            <li>
              <Link to="/twitterApi" className="">
                <FeatherIcon
                  icon="twitter"

                />
                <span>{props.t("Twitter API")}</span>
              </Link>
            </li>
            <li>
              <Link to="/coinIdentfier" className="">
                <FeatherIcon
                  icon="box"
                />
                <span>{props.t("Coin Identfier")}</span>
              </Link>
            </li>
          </ul>
        </div>
