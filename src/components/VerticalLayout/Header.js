...
const Header = props => {
  ...
  const featchCoinList = async (e) => {
    e.preventDefault()
    props.searchCoinhandler(searchCoin)
      ...
      <header id="page-topbar">
        <div className="navbar-header">
          <div className="d-flex">
            <div className="navbar-brand-box">
              <Link to="/dashboard" className="logo logo-dark">
                ...
                <span className="logo-lg">
                  <img src={logoSvg} alt="" height="24" /> <span className="logo-txt">Twitter Crypto007</span>
                </span>
              </Link>
            ...
            <form  onSubmit={featchCoinList} className="app-search d-none d-lg-block">
              <div className="position-relative">
               
                  <input type="text" className="form-control" placeholder="Search..." onChange={sarchCoinList} />
                  <button type='submit'  className="btn btn-primary" ><i className="bx bx-search-alt align-middle"></i></button>
